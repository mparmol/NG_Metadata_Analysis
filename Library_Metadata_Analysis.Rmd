...
We can observe a strong association between single player games that are action-based, or cooperative multiplayer games. Similarly, online cooperative games have a strong link with PvE games. In turn, RPG games are often related to fantastical worlds.
...
We can see that there is no a clear tendecy of games having a shorter playing time along the years.
